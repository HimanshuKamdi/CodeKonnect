...
const Channels = (props) => {
    ...
    async function createRepository(org, name, description) {
        // const token = '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'; // Your GitHub personal access token
        ...
        try {
            const response = await fetch('https://api.github.com/user/repos', {
                ...
                body: JSON.stringify({
                    ...
                    // Optionally, specify other parameters such as organization if needed
                    // organization: org,
                }),
            });
    ...
    const createChannel = (key) => {
        ...
        const owner = channel.admin;
        const new_repo_name = channel.repo_name;
        const description = channel.description;

        createRepository(owner, new_repo_name, description)
            .then(repository => {
                // Repository created successfully, you can use repository data here
                console.log(repository);
            })
            .catch(error => {
                // Error occurred while creating repository
